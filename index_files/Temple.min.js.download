...
banner.setupDynamic = function() {
    this.animationSources = [ "js/728x90_intro.js" ];
    this.animationLibs = [ "lib_728x90_intro" ];
    this.animationSprites = [ "img/728x90_intro_atlas_.png" ];
    ...
    this.animationSources.push("js/728x90_outro.js");
    this.animationLibs.push("lib_728x90_outro");
    this.animationSprites.push("img/728x90_outro_atlas_.png");
